const footerHtml = `
  <div class="footer-inner">
    <div class="footer-cv">
      ...
      <p class="footer-cv-description">
        信頼と技術で、通信の<br />“新しい当たり前”を創る。
      </p>
    </div>
    ...
    <div class="footer-other">
      <p class="footer-other-link">
        <a href="/conditions/">利用規約</a>（モバイル通信約款・個人情報保護ポリシー・外部送信ポリシー等）
      </p>
