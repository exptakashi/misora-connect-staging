!(function (e, t) {
  ...
  function $(e, t) {
    var r,
      ...
      a = void 0 !== i && i;
    if (null != e)
      if (("object" !== f(e) && (e = [e]), N(e))) for (r = 0, n = e.length; r < n; r++) t.call(null, e[r], r, e);
      else {
        var u,
  ...
  ye.inherits(me, Error, {
    toJSON: function () {
      return { message: this.message, name: this.name, description: this.description, number: this.number, fileName: this.fileName, lineNumber: this.lineNumber, columnNumber: this.columnNumber, stack: this.stack, config: ye.toJSONObject(this.config), code: this.code, status: this.status };
    },
  });
  var be = me.prototype,
    ge = {};
  ...
  var Pe = (function () {
    ...
    Ne = { isBrowser: !0, classes: { URLSearchParams: "undefined" != typeof URLSearchParams ? URLSearchParams : Te, FormData: "undefined" != typeof FormData ? FormData : null, Blob: "undefined" != typeof Blob ? Blob : null }, protocols: ["http", "https", "file", "blob", "url", "data"] },
    ...
    De = u(u({}, Object.freeze({ __proto__: null, hasBrowserEnv: _e, hasStandardBrowserWebWorkerEnv: Ue, hasStandardBrowserEnv: Fe, navigator: Ce, origin: Be })), Ne);
  function Ie(e) {
    function t(e, r, n, o) {
      var i = e[o++];
  ...
  var tt = function (e, t) {
      ...
      return et(function (r) {
        var i = r.loaded,
          ...
          s = o(u);
        n = i;
        var c = m({ loaded: i, total: a, progress: a ? i / a : void 0, bytes: u, rate: s || void 0, estimated: s && a && i <= a ? (a - i) / s : void 0, event: r, lengthComputable: null != a }, t ? "download" : "upload", !0);
        e(c);
      }, r);
    },
    rt = function (e, t) {
  ...
  function st(e, t) {
    ...
    var r = {};
    function n(e, t, r) {
      return ye.isPlainObject(e) && ye.isPlainObject(t) ? ye.merge.call({ caseless: r }, e, t) : ye.isPlainObject(t) ? ye.merge({}, t) : ye.isArray(t) ? t.slice() : t;
    }
    function o(e, t, r) {
  ...
  var ct,
    ...
    lt = function (e) {
      var t,
        ...
        s = n.headers,
        c = n.auth;
      if (((n.headers = s = Ve.from(s)), (n.url = je(at(n.baseURL, n.url), e.params, e.paramsSerializer)), c && s.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), ye.isFormData(o)))
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      ...
                      (S = new Request(n, { method: "POST", body: i, duplex: "half" })), ye.isFormData(i) && (x = S.headers.get("content-type")) && d.setContentType(x), S.body && ((R = rt(O, tt(nt(h)))), (T = b(R, 2)), (k = T[0]), (A = T[1]), (i = mt(S.body, 65536, k, A)));
                    case 15:
                      return ye.isString(y) || (y = y ? "include" : "omit"), (j = "credentials" in Request.prototype), (w = new Request(n, u(u({}, m), {}, { signal: g, method: o.toUpperCase(), headers: d.normalize().toJSON(), body: i, duplex: "half", credentials: j ? y : void 0 }))), (e.next = 20), fetch(w);
                    case 20:
                      return (
                        (P = e.sent),
                    ...
                    case 26:
                      return (
                        ...
                        new Promise(function (e, r) {
                          Qe(e, r, { data: D, headers: Ve.from(P.headers), status: P.status, statusText: P.statusText, config: t, request: w });
                        })
                      );
                    case 30:
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              var r = (t = st(this.defaults, t)),
                ...
                i = r.headers;
              void 0 !== n && Bt.assertOptions(n, { silentJSONParsing: Dt.transitional(Dt.boolean), forcedJSONParsing: Dt.transitional(Dt.boolean), clarifyTimeoutError: Dt.transitional(Dt.boolean) }, !1), null != o && (ye.isFunction(o) ? (t.paramsSerializer = { serialize: o }) : Bt.assertOptions(o, { encode: Dt.function, serialize: Dt.function }, !0)), (t.method = (t.method || this.defaults.method || "get").toLowerCase());
